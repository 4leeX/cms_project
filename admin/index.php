            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    function drawChart() {
                        ...
                        $element_text = ['All Posts', 'Active Posts', 'Draft Posts', 'Comments', 'Unapproved Comment','Subscriber Count', 'Users', 'Categories'];
                        $element_count = [$post_count, $post_published_count, $post_draft_count, $comment_count , $unapproved_comment_count, $subscriber_count, $user_count, $category_count];
